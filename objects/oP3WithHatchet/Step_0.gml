...
var _interact = gamepad_button_check_pressed(0, gp_shoulderr);

phy_speed_x = phy_speed_x + (_hor * move_speed);
phy_speed_y = phy_speed_y + (_ver * move_speed);

if (place_meeting(x, y, [oSword, oSpike, oSledgeHammmerP1, oHatchetP1, oHatchetP2, oHatchetP4]))
{
	instance_destroy();
}
...
if (_interact == true)
{
	...
	else
	{
		...
		if (collision_circle(x, y, 65, oHatchetP3, false, true) != noone)
		{
